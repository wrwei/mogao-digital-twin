...
export default {
    ...
    data() {
        return {
            form: {
                name: this.mural?.name || '',
                description: this.mural?.description || '',
                reference: this.mural?.reference || '',
                label: this.mural?.label || '',
                creationPeriod: this.mural?.creationPeriod || '',
                lastInspectionDate: this.mural?.lastInspectionDate || null,
                inspectionNotes: this.mural?.inspectionNotes || '',
                material: this.mural?.material || '',
                period: this.mural?.period || '',
                conservationStatus: this.mural?.conservationStatus || '',
                width: this.mural?.width || null,
                height: this.mural?.height || null,
                technique: this.mural?.technique || ''
            },
            errors: {},
            loading: false,
            touched: {}
