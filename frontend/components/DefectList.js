...
export default {
    ...
    computed: {
        ...
        selectedItem() {
            ...
            return this.defects.find(item => item.gid === this.selectedGid);
        }
    },
    mounted() {
        ...
        this.$nextTick(() => {
            setTimeout(() => {
                const container = document.querySelector('.defect-list-container');
                const viewerPanel = document.querySelector('.entity-viewer-panel');

                console.log('=== Defect List Layout Debug ===');
                if (container) {
    ...
    template: `
        <div class="defect-list-container" style="display: grid; grid-template-columns: 280px 1fr; width: 100%; height: calc(100vh - 140px); gap: 0;">
            <!-- Left Panel: List -->
            <div class="entity-list-panel" style="border-right: 1px solid var(--border); overflow-y: auto; display: flex; flex-direction: column; background: white;">
                <div class="list-header" style="padding: var(--spacing-md); border-bottom: 1px solid var(--border);">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--spacing-md);">
                        <h2 style="margin: 0; font-size: 1.2em;">{{ t('entities.defects') }}</h2>
