    ...
    template: `
        <div class="card mural-card"
            ...
            <div class="card-footer">
                <button v-if="!isGuest" class="btn btn-sm" @click.stop="$emit('edit', mural)" :title="t('common.edit')">
                    {{ t('common.edit') }}
                </button>
                <button v-if="!isGuest" class="btn btn-sm btn-danger" @click.stop="$emit('delete', mural)" :title="t('common.delete')">
                    {{ t('common.delete') }}
                </button>
            </div>
        </div>
