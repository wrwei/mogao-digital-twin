    ...
    template: `
        <div class="detail-view">
            ...
            <div class="detail-content">
                ...
                <!-- Defects Section -->
                <div v-if="painting.defects && painting.defects.length > 0" class="detail-section defects-section">
                    <h2 class="section-title">{{ t('entities.defects') }} ({{ painting.defects.length }})</h2>
                    <div class="defects-list">
                        <div v-for="defect in painting.defects" :key="defect.gid" class="defect-item" style="border: 1px solid var(--border); border-radius: var(--radius-md); padding: var(--spacing-md); margin-bottom: var(--spacing-sm);">
