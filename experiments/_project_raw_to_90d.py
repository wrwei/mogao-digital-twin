...
fig.suptitle("Per-pigment $\\Delta E^*_{ab}$ trajectories: 34-day measured pilot + 56-day first-order saturating model projection (raw-source pipeline)",
             y=0.99, fontsize=11.5, fontweight="bold")
fig.text(0.5, 0.025,
         "Days 0-34: outlier-filtered (Hampel) colorimetry from the raw pilot file.  Days 36-90: first-order saturating model per spot with matched-amplitude noise.  "
